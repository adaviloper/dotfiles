...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/0t/qy9m3pgj1jz_9lwl6hztstp40000gn/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/hackeysack09/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/hackeysack09/.mailcheckrc"
# }
