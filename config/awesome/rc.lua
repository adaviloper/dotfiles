...
clientkeys = gears.table.join(
    ...
    awful.key({ "Shift", "Mod1", "Mod4", "Control" }, "m", function()
        local grabber
    ...
    end, { description = "prepare to move focused window", group = "custom" })
)

local moom_key_binds = gears.table.join(
    -- awful.key({}, "a", function()
        -- if waiting_for_position_key then
            -- move_focused_client_fraction(0, 1/4)
            -- waiting_for_position_key = false
        -- end
    -- end, { description = "move focused client: a", group = "custom" }),
...
globalkeys = gears.table.join(globalkeys, moom_key_binds)
