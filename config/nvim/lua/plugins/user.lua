  ...
  -- customize alpha options
  {
    ...
    opts = function(_, opts)
      ...
      opts.section.header.opts.hl = {
        ...
        { { "NeovimDashboardLogo1", 2, 45 }, },
        { { "NeovimDashboardLogo1", 2, 45 }, },
        { { "NeovimDashboardLogo3", 5, 18 }, { "NeovimDashboardLogo1", 18, 24 }, { "NeovimDashboardLogo3", 24, 45 } },
        { { "NeovimDashboardLogo1", 2, 21 }, { "NeovimDashboardLogo3", 22, 45 } },
        { { "NeovimDashboardLogo1", 2, 19 }, { "NeovimDashboardLogo3", 20, 45 } },
        { { "NeovimDashboardLogo1", 2, 19 }, { "NeovimDashboardLogo3", 19, 45 } },
