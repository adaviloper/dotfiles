...
return {
  ...
  n = {
    ...
    ["<leader>ma"] = { function () require("harpoon.mark").tag() end, desc = "Add file to Harpoon list" },
    ["<leader>md"] = { function () require("harpoon.mark").untag() end, desc = "Remove file from Harpoon list" },
    ["<leader>mm"] = { function () require("grapple").toggle() end, desc = "Toggle Grapple mark" },
